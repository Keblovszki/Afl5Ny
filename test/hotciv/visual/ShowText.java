...
/**
 * Test the TextFigure to display age in the status panel.
 * 
...
public class ShowText {
	...
	public static void main(String[] args) {
		...
		DrawingEditor editor = new MiniDrawApplication("Click to see age text change...", new HotCivFactory3(game));
		editor.open();
...
class HotCivFactory2 implements Factory {
	...
	public DrawingView createDrawingView(DrawingEditor editor) {
		DrawingView view = new StdViewWithBackground(editor, "hotciv-background");
		return view;
	}
